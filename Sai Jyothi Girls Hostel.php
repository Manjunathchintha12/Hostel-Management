...
<style>
body{
background-image:url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2xGrygQ7xbXFearBlxtFGqU9BtOjc6lNLog&usqp=CAU");
...
background-color:RGB(27, 95, 204);
}
</style>  
</head>
<body>
...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:white;font-size:50px;font-family:Cooper"><b>Sai Jyothi Girls Hostel<b></h1>
...
<div class="container ">
  ...
  <table class="table table-hover" border="2px solid red"  width="100%">
    <tr><td><h1><strong>Name of the Hostel: </strong>Sai Jyothi Girls Hostel</h1></td></tr>
<tr><td><h1><strong>OwnerName: Manvitha</strong></h1></td></tr>
<tr><td><h1><strong>Owner Contact: </strong>9959852312</h1></td></tr>
<tr><td><h1><strong>Address:</strong>A.Rangampeta,Sree sainath Nagar Tirupati 517102</h1></td></tr>
...
<strong>1st Installment:</strong>25,000/-<br>   <strong>2nd Installment</strong>:30,000/-</h1></td></tr>
  </table>
  </div>
</div>
