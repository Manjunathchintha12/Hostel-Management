...
<style>
body{
background-image:url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvoryBaem_pzqZ9I747P6VLPebHON2PtCUMw&usqp=CAU");
...
background-color:RGB(68, 224, 20);
}
</style>  
</head>
<body>
...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:white;font-size:50px;font-family:Cooper"><b>Sai Girija girls  Hostel<b></h1>
...
<div class="container ">
  ...
  <table class="table table-hover" border="2px solid red"  width="100%">
    <tr><td><h1><strong>Name of the Hostel: </strong>Sai Girija Girls Hostel</h1></td></tr>
<tr><td><h1><strong>OwnerName: Lakshmi Devi</strong></h1></td></tr>
<tr><td><h1><strong>Owner Contact: </strong>9556839121</h1></td></tr>
<tr><td><h1><strong>Address:</strong>A.Rangampeta Tirupati 517102</h1></td></tr>

<tr><td><h1><strong>Hostel Facilities:<br>1.wifi<br>2.Hot water<br>3.CC camera<br>4.Mineral Water<br>5.AC<br></strong></td></tr>
...
<strong>1st Installment:</strong>30,000/-<br>   <strong>2nd Installment</strong>:30,000/-</h1></td></tr>
  </table>
  </div>
</div>
