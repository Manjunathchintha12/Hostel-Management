...
<style>
body{
background-image:url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThdzaiOaZOoU6K6CS4SkDBuX2THwxPrjaT9Q&usqp=CAU");
...
background-color:RGB(226, 230, 16);
}
</style>  
</head>
<body>
...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:white;font-size:50px;font-family:Cooper"><b>Sai siva Jyothi Girls Hostel<b></h1>
...
<div class="container ">
  ...
  <table class="table table-hover" border="2px solid red"  width="100%">
    <tr><td><h1><strong>Name of the Hostel: </strong>Sai siva Jyothi Girls Hostel</h1></td></tr>
<tr><td><h1><strong>OwnerName: Jyothi,Chandra Babu</strong></h1></td></tr>
<tr><td><h1><strong>Owner Contact: </strong>9632581475</h1></td></tr>
<tr><td><h1><strong>Address:</strong>Sree sainath nagar,A.Rangampeta Tirupati</h1></td></tr>
