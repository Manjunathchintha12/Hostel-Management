...
<style>
body{
background-image:url("https://i.pinimg.com/originals/79/26/30/792630d0ffeee67dda34f51c6a2546f3.jpg");
...
background-color:RGB(14, 24, 227);
}
</style>  
</head>
<body>
...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:black;font-size:50px;font-family:Cooper"><b>Venky's Plaza<b></h1>
...
<div class="container ">
  ...
  <table class="table table-hover" border="2px solid red"  width="100%">
    <tr><td><h1><strong>Name of the Hostel: </strong>Venky's Plaza</h1></td></tr>
<tr><td><h1><strong>OwnerName: Venkatappa Naidu</strong></h1></td></tr>
<tr><td><h1><strong>Owner Contact: </strong>6309079780</h1></td></tr>
