...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:black;font-size:50px;font-family:Cooper"><b>Balaji    Boys  Hostel<b></h1>
...
<div class="mySlides fade">
  ...
  <img src="hostel21.jpeg" style="width:100%">
  <div class="text">Image1</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="hostel22.jpeg" style="width:100%">
  <div class="text">Image2</div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="hostel23.jpeg" style="width:100%">
...
<div class="container ">
  ...
  <table class="table table-hover" border="2px solid red"  width="100%">
    <tr><td><h1><strong>Name of the Hostel: </strong>Balaji Boys Hostel</h1></td></tr>
<tr><td><h1><strong>OwnerName: Tirumala Naidu</strong></h1></td></tr>
<tr><td><h1><strong>Owner Contact: </strong>9291340745</h1></td></tr>
<tr><td><h1><strong>Address:</strong>Sree Sainathnagar,A.Rangampeta Tirupati</h1></td></tr>
...
<strong>1st Installment:</strong>24,000/-<br>   <strong>2nd Installment</strong>:26,000/-</h1></td></tr>
  </table>
  </div>
</div>
