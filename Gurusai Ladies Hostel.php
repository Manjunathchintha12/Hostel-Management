...
background-color:RGB(222, 16, 88);
}
</style>  
</head>
<body>
...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:white;font-size:50px;font-family:Cooper"><b>Gurusai Ladies Hostel<b></h1>
...
<div class="container ">
  ...
  <table class="table table-hover" border="2px solid red"  width="100%">
    <tr><td><h1><strong>Name of the Hostel: </strong>Gurusai Ladies Hostel</h1></td></tr>
<tr><td><h1><strong>OwnerName: G.Ramesh Babu</strong></h1></td></tr>
<tr><td><h1><strong>Owner Contact: </strong>9331512112</h1></td></tr>
...
<tr><td><h1><strong>Total Vacancies Available: </strong>8</h1></td></tr>
